...
### 4.6 Success Rate by Condition

We further break down RL performance by **distance**, **winds**, **pressure**, **temperature**, and **slip**.

#### By Distance  
![Success by Distance](plots/output_6_4.png)

- **25–34 yards:** ≈92–93% success  
- **35–44 yards:** ≈92%  
- **45–54 yards:** ≈89%  
- **55–64 yards:** ≈78%  
- **65–75 yards:** ≈80%  

As in real NFL data, **distance is the single strongest difficulty driver**, and even the RL agent cannot fully overcome long-range difficulty.

---

#### By Headwind  
![Success by Headwind](plots/output_6_5.png)
...
- The agent adapts to moderate headwinds but struggles under extreme headwind conditions.
- Tailwinds slightly boost performance by effectively extending range.

---

#### By Crosswind  
![Success by Crosswind](plots/output_6_6.png)

- Strong left crosswind: ≈88%  
- Strong right crosswind: ≈76%  
- Calm / mild crosswinds: > 88–90%  

**Interpretation:**

- Crosswinds create asymmetrical difficulty (strong rightward winds are more harmful).
- This likely relates to how horizontal drift and goalpost geometry interact in the simulation.

---

#### By Pressure  
![Success by Pressure](plots/output_6_7.png)
...
- Higher pressure injects more execution noise into the kick, reducing consistency.
- The agent still performs reasonably but shows a noticeable drop.

---

#### By Temperature  
![Success by Temperature](plots/output_6_8.png)
...
- In cold conditions, the simulated ball travels less far, making longer kicks harder.
- The agent compensates partially (by kicking harder and steeper) but cannot fully eliminate the penalty.

---

#### By Slip  
![Success by Slip](plots/output_6_9.png)

- All slip levels fall between ≈87–89%

**Interpretation:**

- Although slip increases noise, the agent’s policy (favoring slightly higher velocity and robust angles) buffers much of the instability.
- Slip is thus the least impactful factor in terms of aggregate success rate.
...
*(To be updated upon recording)*

- **Demo Video (Non-Technical):** _coming soon_  
- **Technical Walkthrough Video:** _coming soon_  

These videos will:

- Explain the project motivation in non-technical language.
- Show how the supervised model and RL system work together.
- Walk through design choices and evaluation results.
...
- All modeling, environment design, experimentation, and implementation were done by me.
- AI assistance was used for:
  - Drafting and refining documentation.
  - Formatting and organizing code comments and markdown.
  - Suggesting plot and evaluation structures.

All core technical work (data pipelines, model training, RL environment, DQN implementation, and analysis) is my own.
